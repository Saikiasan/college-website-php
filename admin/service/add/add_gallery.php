    ...
    <div id="wrapper">
        <div class="container">
            ...
            <div class="col-sm-5 mb-4">
                        ...
                        <div class="row align-items-center">
                            <div class="col me-2">
                                <div class="text-uppercase text-success fw-bold text-xs mb-1">
                                    <span>Add new image in the Gallery</span>
                                </div>
                            </div>
                ...
                <form method="post" action="insert_gallery_img.php" enctype="multipart/form-data" class="d-flex flex-column form">
                    
                    <div class="col-md mb-2">
                        <label for="img_title">Title</label>
                        <input type="text" name="img_title" class="form-control" maxlength="30">
                    </div>

                    <div class="col-md mb-2">
                        <label for="img_description">Description</label>
                        <input type="text" name="img_description" class="form-control" maxlength="30">
                    </div>
                                           
                    <div class="col-md mb-2">
                        <label for="image_file">Photo</label>
                        <input type="file" name="image_file" class="form-control" accept="image/png, image/jpg, image/jpeg" required>
                    </div>

                    <div class="row justify-content-evenly my-2">
                        <input type="submit" name="submit" value="Upload" class="btn btn-primary col-sm-4">
                        <a href="../gallery.php" class="btn btn-danger col-sm-4">Cancel</a>
                    </div>
