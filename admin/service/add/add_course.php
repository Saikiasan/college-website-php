    ...
    <div id="wrapper">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <form method="post" action="insert_course.php" class="d-flex flex-column form">
                    <div class="col-md mb-2">
                    <label for="c_id">Course ID</label>
                    <input type="text" name="c_id" class="form-control" maxlength="50" autofocus>
                    </div>

                    <div class="col-md mb-2">
                    <labenamse">Course name</label>
                    <input type="text" name="name" class="form-control" maxlength="50" autofocus>
                    </div>

                    <div class="col-md mb-2">
                        <labedesscription">Description</label>
                        <input type="text"name="description" class="form-control" maxlength="50" title="Provide description for the course" >
                    </div>
                    ...
                    <div class="row justify-content-evenly my-2">
                        ...
                        <a href="../courses.php" class="btn btn-danger col-sm-4">Cancel</a>
                    </div>
